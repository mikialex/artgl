...
impl Pi for f32       { #[inline(always)] fn pi() -> Self { 3.14159265359_f32 } }
...
impl PiByC180 for f32 { #[inline(always)] fn pi_by_c180() -> Self { 3.14159265359_f32 / 180.0_f32 } }
impl C180ByPi for f32 { #[inline(always)] fn c180_by_pi() -> Self { 180.0_f32 / 3.14159265359_f32 } }
...
impl Pi for f64       { #[inline(always)] fn pi() -> Self { 3.141592653589793238462643383279502884197169399375105820974944592307816406286_f64 } }
...
impl Epsilon for f64  { #[inline(always)] fn epsilon() -> Self { 0.00000001_f64 } }